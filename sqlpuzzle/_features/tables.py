...
class Tables(sqlpuzzle._features.Features):
    ...
    def join(self, arg):
        ...
        self._features[-1].join(arg, INNER_JOIN)
        return self
    ...
    def leftJoin(self, arg):
        ...
        self._features[-1].join(arg, LEFT_JOIN)
        return self
    ...
    def rightJoin(self, arg):
        ...
        self._features[-1].join(arg, RIGHT_JOIN)
        return self
