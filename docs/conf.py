...
htmlhelp_basename = 'SQLPuzzle Documentation'
...
latex_documents = [
  ('index', 'SQLPuzzle.tex', u'SQLPuzzle Documentation',
...
man_pages = [
    ('index', 'sqlpuzzle', u'SQLPuzzle Documentation',
     [u'Michal Horejsek'], 1)
]
...
texinfo_documents = [
  ('index', 'SQLPuzzle', u'SQLPuzzle Documentation',
   u'Michal Horejsek', 'SQLPuzzle', 'One line description of project.',
   'Miscellaneous'),
]
